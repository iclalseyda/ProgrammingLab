...
public class BulkOperations {public static void main(String[] args) {
    ...
    list.removeAll( Arrays.asList(3,5,8) ); //[1, 2, 4, 6, 7, 9, 10]
    ...
    boolean r2 = nums.contains(2) && nums.contains(5) && nums.contains(10); //true
    ...
    ArrayList<String> namesList = new ArrayList<>(Arrays.asList(names)); //easy way to add.
